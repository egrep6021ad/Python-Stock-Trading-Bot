...
from ..visualization.plot import Plot, plot_aucKfold, plot_importance_Kfold, plot_train_test, \
...
class ModelWithPipeline(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        if self.model_name.lower() == 'dl' or 'deep' in self.model_name.lower():
            ...
            self.model.compile(keras.optimizers.Adam(lr=self.learning_rate), loss='binary_crossentropy',
                               metrics=['accuracy'])
